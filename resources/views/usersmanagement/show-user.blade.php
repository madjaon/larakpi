        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="col-sm-7">
              ...
              @if($user->level() >= 5)
                <span class="badge badge-danger margin-half margin-left-0">5</span>
              @endif

              @if($user->level() >= 4)
                 <span class="badge badge-warning margin-half margin-left-0">4</span>
              @endif
              ...
              @if($user->level() >= 2)
                <span class="badge badge-primary margin-half margin-left-0">2</span>
              @endif

              @if($user->level() >= 1)
                <span class="badge badge-info margin-half margin-left-0">1</span>
              @endif
