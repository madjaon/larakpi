                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <!-- <div style="display: flex; justify-content: space-between; align-items: center;"> -->
                            ...
                            Danh sách Đơn vị tính: {{ count($data) }}/{{ $data->total() }}

                            <a href="{{ URL::to('kpiunit/create') }}" class="btn btn-primary btn-xs pull-right mr-1 mb-1">
                                ...
                                <tbody>
                                    @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::open(array('url' => 'kpiunit/' . $value->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="{{ URL::to('kpiunit/' . $value->id . '/edit') }}" data-toggle="tooltip" title="Sửa">
